...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		RemoveTransactionsCommand removeTransactionsCommand = new RemoveTransactionsCommand(transactionsTable.getSelectionModel().getSelectedItems(), data);
	...
	public void setCommandRegistry(CommandRegistry commandRegistry) {
		...
		redoButton.disableProperty().bind(Bindings.isEmpty(commandRegistry.getUndoneCommandStack()));
	}
}
